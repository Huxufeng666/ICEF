...
train_data = get_data(image_dir='/home/ami-1/HUXUFENG/UIstasound/Dataset_BUSI_with_GT/BUSI/train/images',
                      mask_dir='/home/ami-1/HUXUFENG/UIstasound/Dataset_BUSI_with_GT/BUSI/train/masks'
                    )
val_data = get_data(image_dir='/home/ami-1/HUXUFENG/UIstasound/Dataset_BUSI_with_GT/BUSI/val/images',
                    mask_dir='/home/ami-1/HUXUFENG/UIstasound/Dataset_BUSI_with_GT/BUSI/val/masks')
...
for epoch in range(1, num_epochs + 1):
    ...
    for imgs, masks in tqdm(train_loader, desc=f"[Train] Epoch {epoch}"):
        ...
        loss_dice = dice_loss_per_sample(logits, masks).mean()
    ...
    # ---------- 保存最优权重 ----------
    model_file = os.path.join(log_dir, f"model_{avg_val:.4f}.pth")
